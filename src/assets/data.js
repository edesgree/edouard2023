...
import labMindQuizCover from './images/lab/mindquiz/mindquiz-cover.webp';
import labMindQuizScreenshot from './images/lab/mindquiz/mindquiz-screenshot.webp';
import labMyLibraryCover from './images/lab/mylibrary/mylibrary-cover.webp';
...
const data = {
    common: {
        ...
        labSubTitle: {
            fr: `Des petits projets perso en JavaScript`,
            en: `Some small personal projects in JavaScript`
        },
        workMyworkTitle: {
            fr: `Mon travail`,
            en: `What i did`
    ...
    lab: [
        {
            ...
            name: 'My Library',
            slug: 'mylibrary',
            subtitle: 'Movie watch list in Vue JS',
            date: '14-10-2023',
            description: {
        ...
        `
            ...
            images: {
                cover: labMyLibraryCover,
                screens: [labMyLibraryScreenshot]
            },
            github: 'https://github.com/edesgree/vuejs-my-library',
            preview: 'https://monumental-blini-0cf39d.netlify.app/'
        },
        {
            id: nanoid(),
            name: 'Mind Quiz',
...
The project is using <a href="https://reactjs.org/" target="_blank">ReactJS</a>, coded in TypeScript, on a <a href="https://vitejs.dev/" target="_blank">Vite.js</a> base. It uses Framer motion for animations. The data is coming from a json file. The images and texts were generated by AI.
      `
            ...
            images: {
                cover: labMindQuizCover,
                screens: [labMindQuizScreenshot]
            },
            github: 'https://github.com/edesgree/react-psycho-test',
            preview: 'https://spectacular-alfajores-5af175.netlify.app/'
        },
        {
            id: nanoid(),
            name: 'CV Generator',
